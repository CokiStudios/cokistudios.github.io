...
echo "[APP] Compilando CSMS para macOS (Binario Universal x86_64 y arm64)..."
...
echo "[MODULE] Compilando para Apple Silicon (arm64)..."
...
echo "[MODULE] Compilando para Intel (x86_64)..."
...
echo "[OK] ¡CSMS App compilada con éxito como Binario Universal!"
echo " Bundle: $APP_BUNDLE"
echo "[MODULE] ZIP Universal: $DIR/CSMS-macOS-Universal.zip"
